...
!(function (e, t, n, o, r) {
    ...
    function Zn(e, t) {
        return (t = 1 < arguments.length ? t : ln)
    ...
    function Fn() {
        return 'innerHeight' in rn
            ? rn.innerHeight
            : ln.documentElement.offsetHeight;
    }
    function Un() {
    ...
    function eo(e, t) {
        e = oo(e) ? e[0] : e;
        for (
            var n = null != t ? Zn(t, e.parentNode) : e.parentNode.childNodes,
                o = 0,
                r = 0;
            r < n.length;
            r++
    ...
    function so(e, t) {
        for (
            'string' == typeof t && (t = yo(t)), e.appendChild(t);
            e.firstChild !== t;
    ...
    function So(e, t, n) {
        var o;
        (n = void 0 === n ? {} : n),
            'function' == typeof rn.CustomEvent
                ? (o = new CustomEvent(t, { detail: n }))
                : (o = ln.createEvent('CustomEvent')).initCustomEvent(
                      t,
                      !0,
                      !0,
                      n
    ...
    return (
        ...
        function (e, g) {
            var n =
                    ...
                    -1 < ln.domain.indexOf('alvarotrigo.com'),
                r = Zn('html, body'),
                s = Zn('html')[0],
                m = Zn('body')[0];
            if (!Gn(s, dn)) {
                ...
                g = Xn(
                    {
                        ...
                        scrollOverflowHandler: rn.fp_scrolloverflow
                            ? rn.fp_scrolloverflow.iscrollHandler
                            : null,
                ...
                var p,
                    ...
                    I = {
                        ...
                        touchstart:
                            'ontouchstart' in rn ? 'touchstart' : R.down,
                    },
                    z = !1,
                ...
                try {
                    ...
                    rn.addEventListener('testPassive', null, P),
                        rn.removeEventListener('testPassive', null, P);
                } catch (e) {}
                var W,
                    D,
                    Y = Xn({}, g),
                    ...
                    w &&
                        ...
                        (S.destroy = function (e) {
                            So(w, 'destroy', e),
                                ...
                                e &&
                                    ...
                                    Zn('img[data-srcset]').forEach(function (
                                        e
                                    ) {
                                        Qe(e, 'srcset');
                                    }),
                        ...
                        (S.test = {
                            ...
                            translate3dH: (function () {
                                for (
                                    var e = [], t = 0;
                                    t < Zn(g.sectionSelector, w).length;
                                    t++
                                )
                        ...
                        (function () {
                            Qn(w, { height: '100%', position: 'relative' }),
                                ro(w, an),
                                ro(s, dn),
                                (y = Fn()),
                                io(w, fn),
                                ro(Zn(g.sectionSelector, w), mn),
                                ro(Zn(g.slideSelector, w), Tn),
                                Qt('parallax', 'init');
                            ...
                            g.fixedElements &&
                                ...
                                g.navigation &&
                                    (function () {
                                        ...
                                        (Zn('ul', n)[0].innerHTML = o),
                                            Qn(Zn(Ln), {
                                                'margin-top':
                                                    '-' +
                                                    Zn(Ln)[0].offsetHeight / 2 +
                                                    'px',
                                            }),
                                            ro(
                                                Zn(
                                ...
                                Qt('cards', 'init'),
                                g.scrollOverflow &&
                                    (p = g.scrollOverflowHandler.init(g));
                        })(),
                        se(!0),
                        ce(!0),
            ...
            function oe(e, t) {
                ...
                if (g.autoScrolling && !g.scrollBar)
                    Qn(r, { overflow: 'hidden', height: '100%' }),
                        re(Y.recordHistory, 'internal'),
                        Qn(w, {
                    ...
                    (Qn(r, { overflow: 'visible', height: 'initial' }),
                    re(!!g.autoScrolling && Y.recordHistory, 'internal'),
                    Qn(w, { '-ms-touch-action': '', 'touch-action': '' }),
                    Ft(w),
                    null != n)
                ) {
            ...
            function ie(e, t) {
                'internal' !== t &&
                    Ut('fadingEffect') &&
                    S.fadingEffect.update(e),
                    Ut('cards') && S.cards.update(e),
                ...
                e
                    ? ((function () {
                          ...
                          rn.addEventListener
                              ...
                              : ((e = 'attachEvent'), (t = 'on'));
                          var n =
                                  'onwheel' in ln.createElement('div')
                                      ? 'wheel'
                                      : void 0 !== ln.onmousewheel
                                      ? 'mousewheel'
                                      : 'DOMMouseScroll',
                              o = !!j && { passive: !1 };
                          'DOMMouseScroll' == n
                              ? ln[e](t + 'MozMousePixelScroll', Pe, o)
                              : ln[e](t + n, Pe, o);
                      })(),
                      w.addEventListener('mousedown', vt),
                      w.addEventListener('mouseup', pt))
                    : (ln.addEventListener
                          ? (ln.removeEventListener('mousewheel', Pe, !1),
                            ln.removeEventListener('wheel', Pe, !1),
                            ln.removeEventListener(
                                'MozMousePixelScroll',
                                Pe,
                                !1
                            ))
                          : ln.detachEvent('onmousewheel', Pe),
                      w.removeEventListener('mousedown', vt),
                      w.removeEventListener('mouseup', pt));
            }
            function se(t, e) {
                void 0 !== e
                    ? (e = e.replace(/ /g, '').split(',')).forEach(function (
                          e
                      ) {
                          Gt(t, e, 'm');
                      })
                    ...
                    ? (ae(!0),
                      (function () {
                          if (i || u) {
                              ...
                              e.removeEventListener(I.touchstart, Ne),
                                  e.removeEventListener(I.touchmove, ze, {
                                      passive: !1,
                                  }),
                                  e.addEventListener(I.touchstart, Ne),
                                  e.addEventListener(I.touchmove, ze, {
                                      passive: !1,
                                  });
                          }
                      })())
            ...
            function fe() {
                var e = _n(Zn(bn)[0], Sn);
                e || (!g.loopTop && !g.continuousVertical) || (e = qn(Zn(Sn))),
                    null != e && Ve(e, null, !0);
            }
            function de() {
                var e = Jn(Zn(bn)[0], Sn);
            ...
            function me(e) {
                if (!Gn(w, fn)) {
                    ...
                    l && !Ut('fadingEffect') && ve(l + 1),
                        ...
                        mo(g.afterReBuild) && !e && g.afterReBuild.call(w),
                        So(w, 'afterRebuild');
                }
            }
            function Se() {
            ...
            function be(e) {
                ...
                e
                    ? t ||
                      ...
                      g.scrollOverflow && p.createScrollBarForAll())
                    : t &&
                      (oe(Y.autoScrolling, 'internal'),
                      le(Y.autoScrolling, 'internal'),
                      no(Zn(Ln)),
                      io(m, cn),
                      mo(g.afterResponsive) && g.afterResponsive.call(w, e),
                      Qt('responsiveSlides', 'toSlides'),
                      So(w, 'afterResponsive', e));
            }
            function we(e) {
                var t = e.target;
                    ...
                    : uo(t, g.menu + ' [data-menuanchor]') &&
                      function (e) {
                          !Zn(g.menu)[0] ||
                              ...
                              (go(e), pe(this.getAttribute('data-menuanchor')));
                      }.call(t, e);
            }
            function ye(e, t) {
            ...
            function Le(e, t, n) {
                ...
                var c = Zn(kn, e)[0];
                null != c &&
                (0 !== eo(Zn(bn), Sn) || (0 === eo(Zn(bn), Sn) && 0 !== eo(c)))
                    ? (Vt(c, 'internal'), ro(c, 'fp-initial'))
                    : ro(t[0], pn);
            }
            function Me(e) {
            ...
            function Te(e, t) {
                t || null != Zn(bn)[0] || ro(e, pn),
                    ...
                    g.paddingBottom &&
                        Qn(e, { 'padding-bottom': g.paddingBottom }),
                    void 0 !== g.sectionsColor[t] &&
                        Qn(e, { 'background-color': g.sectionsColor[t] }),
                    void 0 !== g.anchors[t] &&
                        e.setAttribute('data-anchor', g.anchors[t]);
            }
            function Oe(e, t) {
                return (
                    g.navigationTooltips[e] || g.anchors[e] || t + ' ' + (e + 1)
                );
            }
            function ke() {
                var e,
                ...
                ro(n, gn),
                    ...
                    (e = ut()),
                    (t = It(e.section)),
                    (e.section && t && (void 0 === t || eo(t) !== eo(o))) ||
                        !mo(g.afterLoad) ||
                        Ze('afterLoad', {
                            activeSection: n,
                            element: n,
            ...
            function Ce() {
                ...
                if (
                    (So(w, 'onScroll'),
                    (!g.autoScrolling || g.scrollBar || Ut('dragAndMove')) &&
                        !Jt())
                ) {
                    var t = Ut('dragAndMove')
                ...
                if (Be(e)) {
                    ...
                    (K = n.y),
                        ...
                        Zn(Hn, t).length && Math.abs(J - $) > Math.abs(_ - K)
                            ? !a &&
                              Math.abs(J - $) >
                                  (Un() / 100) * g.touchSensitivity &&
                              ($ < J ? v.m.right && he(t) : v.m.left && ge(t))
                            : g.autoScrolling &&
                              x &&
                              Math.abs(_ - K) >
                                  (rn.innerHeight / 100) * g.touchSensitivity &&
                              (K < _ ? Re('down') : _ < K && Re('up'));
                }
            }
            function Be(e) {
            ...
            function Ye(e) {
                var t = e.offsetHeight,
                    ...
                    o = n,
                    r =
                        Ut('dragAndMove') && S.dragAndMove.isGrabbing
            ...
            function Ve(e, t, n) {
                if (null != e) {
                    ...
                    if (
                        !(
                            (i.activeSection == e && !E) ||
                            (g.scrollBar && po() === i.dtop && !Gn(e, En))
                        )
                    ) {
                        if (
                            (null != i.activeSlide &&
                                ((o = i.activeSlide.getAttribute(
                                    'data-anchor'
                                )),
                                (r = eo(i.activeSlide))),
                            !i.localIsResizing)
                            ...
                            g.autoScrolling &&
                                ...
                                ((!i.isMovementUp && 'up' == i.yMovement) ||
                                    (i.isMovementUp &&
                                        'down' == i.yMovement)) &&
                                ((s = i).isMovementUp
                                    ? vo(Zn(bn)[0], xo(s.activeSection, Sn))
                                    : fo(
                                          Zn(bn)[0],
                                          Ao(s.activeSection, Sn).reverse()
                                      ),
                                ...
                                (s.leavingSection =
                                    eo(s.activeSection, Sn) + 1),
                                (s.sectionIndex = eo(s.element, Sn)),
                                So(Zn(sn)[0], 'onContinuousVertical', s),
                                (i = s)),
                            Ut('scrollOverflowReset') &&
                                S.scrollOverflowReset.setPrevious(
                                    i.activeSection
                                ),
            ...
            function Fe(e) {
                ...
                return (
                    g.autoScrolling && !g.scrollBar
                        ? ((t.options = -e), (t.element = Zn(sn)[0]))
                        : ((t.options = e), (t.element = rn)),
                    t
                );
            }
            function Ue(e) {
                ...
                null != (t = e).wrapAroundElements &&
                    (t.isMovementUp
                        ? vo(Zn(Sn)[0], t.wrapAroundElements)
                        : fo(Zn(Sn)[Zn(Sn).length - 1], t.wrapAroundElements),
                    Zt(Zn(bn)[0].offsetTop),
                    De(),
            ...
            function _e() {
                var e =
                    Zn('.fp-auto-height')[0] ||
                    (Se() && Zn('.fp-auto-height-responsive')[0]);
                g.lazyLoading &&
                    e &&
            ...
            function $e(e) {
                ...
                Zn('video, audio', t).forEach(function (e) {
                    ...
                    Zn('iframe[src*="youtube.com/embed/"]', t).forEach(
                        function (e) {
                ...
                function o(e) {
                    ...
                    for (e = e.replace(/[^A-Za-z0-9+/=]/g, ''); s < e.length; )
                        (t =
                            ...
                            (n =
                                ((15 & r) << 4) |
                                ((i = c.indexOf(e.charAt(s++))) >> 2)),
                            (o =
                                ((3 & i) << 6) |
                                (l = c.indexOf(e.charAt(s++)))),
            ...
            function lt(e) {
                if (
                    ...
                    B ||
                        (G = G.replace('extensions/', '').replace(
                            'Extension',
                            ''
                        )),
                    (F.innerHTML = G),
                    (F = F.firstChild),
                    'MutationObserver' in rn &&
                        new MutationObserver(rt).observe(ln.body, {
                            childList: !0,
                            subtree: !1,
                        }),
                    (!B || (Ut(e) && S[e])) && (!ot(e) || !B))
            ...
            function vt(e) {
                2 == e.which &&
                    ((te = e.pageY), w.addEventListener('mousemove', mt));
            }
            function pt(e) {
                ...
                (r.xMovement = kt(r.prevSlideIndex, r.slideIndex)),
                    ...
                    !1 === Ze('onSlideLeave', r)
                        ...
                        : (ro(t, pn),
                          ...
                          S.continuousHorizontal &&
                              S.continuousHorizontal.apply(r),
                          Jt() ? wt(r) : yt(e, r, !0),
                          g.interlockedSlides &&
                              S.interlockedSlides &&
                              ((Ut('continuousHorizontal') &&
                                  void 0 !== n &&
                                  n !== r.xMovement) ||
            ...
            function bt(e) {
                !g.loopHorizontal &&
                    g.controlArrows &&
                    (wo(Zn(Dn, e.section), 0 !== e.slideIndex),
                    wo(Zn(Yn, e.section), null != $n(e.destiny)));
            }
            function wt(e) {
                var t, n;
                S.continuousHorizontal &&
                    S.continuousHorizontal.afterSlideLoads(e),
                    (t = e.slidesNav),
                    (n = e.slideIndex),
                    g.slidesNavigation &&
                        null != t &&
                        (io(Zn(hn, t), pn), ro(Zn('a', Zn('li', t)[n]), pn)),
                    e.localIsResizing ||
                        (Qt('parallax', 'afterSlideLoads'),
                        Qt('scrollOverflowReset', 'setPrevious', e.prevSlide),
                        Qt('scrollOverflowReset', 'reset'),
                        mo(g.afterSlideLoad) && Ze('afterSlideLoad', e),
                        (x = !0),
                        $e(e.destiny)),
                    (a = !1),
            ...
            function xt() {
                if ((So(w, 'onResize'), At(), i)) {
                    ...
                    if (
                        ...
                        var t = Fn();
                        Math.abs(t - ne) > (20 * Math.max(ne, t)) / 100 &&
                            (me(!0), (ne = t));
                    }
                } else xe();
            }
            ...
            function Lt(e) {
                ...
                return (
                    io(e, un), Qn(e, { '-webkit-transition': t, transition: t })
                );
            }
            function Mt(e) {
                return ro(e, un);
            ...
            function jt(e) {
                if (g.recordHistory) location.hash = e;
                    ...
                    rn.history.replaceState(void 0, void 0, '#' + e);
                else {
            ...
            function Vt(e, t) {
                ie(0, 'internal'),
                    ...
                    St(uo(e, Hn), e),
                    void 0 !== t && (E = !1),
                    ie(Y.scrollingSpeed, 'internal');
            }
            function Zt(e) {
                var t = Math.round(e);
                if (g.css3 && g.autoScrolling && !g.scrollBar)
                    Rt('translate3d(0px, -' + t + 'px, 0px)', !1);
                else if (g.autoScrolling && !g.scrollBar)
                    Qn(w, { top: -t + 'px' }), (S.test.top = -t + 'px');
                else {
                    var n = Fe(t);
            ...
            function qt(t, n, o, r) {
                ...
                var s = function () {
                    if (W) {
                        var e = n;
                        (a += 20),
                            o && (e = rn.fp_easings[g.easing](a, i, l, o)),
                            en(t, e),
            ...
            function en(e, t) {
                !g.autoScrolling || g.scrollBar || (e.self != rn && Gn(e, Cn))
                    ? e.self != rn && Gn(e, Cn)
                        ? (e.scrollLeft = t)
                        : e.scrollTo(0, t)
                    : (e.style.top = t + 'px');
